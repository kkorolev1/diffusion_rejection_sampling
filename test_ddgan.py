...
from rejection_sampling.utils import rejection_sample, rejection_sample_reinit, RejectionSamplingProcessor
...
def sample_and_test(args):
    ...
    if args.use_rejection_sampling:
        ...
        print(f"Rejection Sampling is enabled with {args.enable_reinit=} and {args.constant_quantile=}")
    ...
    if args.compute_fid:
        ...
        # ).to(device)
        # if args.use_rejection_sampling:
        #     fake_sample = rejection_sample_from_model(
        #         pos_coeff, netG, netD, args.num_timesteps, x_t_1, args
        #     )
        # else:
        #     fake_sample = sample_from_model(
        #         pos_coeff, netG, args.num_timesteps, x_t_1, args
        ...
        # fake_sample = to_range_0_1(fake_sample)
        # torchvision.utils.save_image(
        #     fake_sample, "./samples_{}.jpg".format(args.dataset)
        # )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--constant_quantile", type=float, default=0.7)
